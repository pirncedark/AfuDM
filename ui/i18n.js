...
const DICT = {
  tr: {
    ...
    "seed.ekHint": "Bunlar listenin BAŞINA eklenir ve her güncellemede uygulanır. Tek tek peer (IP:port) eklemeyi aria2 desteklemiyor.",
  ...
  en: {
    ...
    "seed.ekHint": "These go to the FRONT of the list and are applied on every refresh. aria2 cannot add single peers (IP:port).",
